...
<div> 
<base-dialog v-if="inputInavalid" title="Invalid Input" @close="confirmError">
<template #default>
...
<template #actions>
   ...
   <form @submit.prevent="submitData">
       ...
       <div class="form-control">
          ...
          <input ref="descInput" id="description" name="description" rows="3"/>
       </div>
       <div class="form-control">
